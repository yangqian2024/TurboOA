...
module.exports = {
	...
	PROJECT_MARK: 'card',
	PROJECT_NAME: 'CC校友名片小程序',
	PROJECT_VER: 'CCCard-Cloud(V1.3 Build20210810)', //升级必须，请勿修改
	PROJECT_SOURCE: 'https://gitee.com/minzonetech',

	CCMINI_CLIENT_CHECK_CONTENT: true,
	CCMINI_ADMIN_CHECK_CONTENT: false,

	CCMINI_COLLECTION_NAME: 'setup|user|admin',
	CCMINI_SETUP_TITLE: 'CC校友名片小程序',
	CCMINI_SETUP_ABOUT: '   栉风沐雨，砥砺歌行，栽桃培李，春华秋实。校友集结号已经向各地吹响，牵动了无数学子的心。\n\n   来把，校友们，朋友们，让我们一起加入校友大家庭！！！',
